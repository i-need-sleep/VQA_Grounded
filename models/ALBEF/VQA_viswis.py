...
if __name__ == '__main__':
    ...
    parser.add_argument('--text_encoder', default='../../pretrained/tokenizer/bert-base-uncased-vocab.txt')
    parser.add_argument('--text_decoder', default='../../pretrained/tokenizer/bert-base-uncased-vocab.txt')
